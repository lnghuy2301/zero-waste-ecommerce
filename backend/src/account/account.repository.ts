...
export class AccountRepository {
    ...
    async updateActive(id: number, account: UpdateActiveRequestDto): Promise<AccountResponseDto> {
        return this.prismaService.account.update({
            where: {
                id: id,
                role: {
    ...
    async updateRole(id: number, account: UpdateRoleRequesrDto): Promise<AccountResponseDto> {
        return this.prismaService.account.update({
            where: {
                id: id,
                role: {
