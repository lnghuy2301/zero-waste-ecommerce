...
export class CustomerProfileRepository {
    ...
    async updateCustomerProfile(id: number, customerProfileRequestDto: CustomerProfileRequestDto): Promise<CustomerProfileResponseDto> {
    ...
    async getCustomerProfileById(id: number): Promise<CustomerProfileResponseDto | null> {
