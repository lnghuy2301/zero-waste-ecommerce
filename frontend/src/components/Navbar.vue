    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <nav class="hidden md:flex items-center space-x-8">
          <RouterLink
            to="/products"
            class="text-sm font-semibold hover:text-[#658a22] text-slate-700"
            >Sản phẩm</RouterLink
          >
          <RouterLink to="/" class="text-sm font-semibold hover:text-primary transition-colors"
        ...
        <div class="flex items-center gap-2 sm:gap-4">
          ...
          <RouterLink
            v-else
            to="/login"
            class="text-xs font-bold text-[#658a22] bg-[#658a22]/10 px-4 py-2 rounded-lg transition-colors hover:bg-[#658a22]/20"
          >
            Đăng Nhập
          </RouterLink>
