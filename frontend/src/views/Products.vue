  ...
  <div class="font-inter">
    ...
    <main class="max-w-[1400px] mx-auto px-4 md:px-8 py-12">
      ...
      <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
        ...
        >
          <div
            class="aspect-square rounded-[24px] overflow-hidden bg-slate-50 mb-5 cursor-pointer"
          ...
          <div class="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
            <div class="flex flex-col">
              ...
              <span class="text-[17px] font-black text-[#d00000]">
                {{
                  Number(getDiscountedPrice(selectedVariants.get(product.id) || {})).toLocaleString(
                    'vi-VN',
                  )
                }}đ
              </span>
